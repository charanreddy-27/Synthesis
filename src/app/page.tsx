    ...
    <main className="relative min-h-dvh">
      ...
      <div className="relative mx-auto flex min-h-dvh w-full max-w-5xl flex-col px-4 py-6 sm:px-8">
        ...
        <div className="flex-1 py-8">
          <ControlRoom defaultQuestion={DEFAULT_QUESTION} />
        </div>
        <Footer />
      </div>
    </main>
...
function TopBar() {
  return (
    <header className="print-hide flex items-center justify-between border-b border-border pb-4">
      <div className="flex items-baseline gap-3">
        <span className="font-display text-lg font-semibold tracking-[0.2em] text-text">SYNTHESIS</span>
      ...
      <div className="flex items-center gap-2 font-mono text-[11px] uppercase tracking-widest text-muted">
        ...
        <span>planner · researchers · critic</span>
      </div>
    </header>
  );
}
...
function Footer() {
  return (
    <footer className="print-hide flex items-center justify-between border-t border-border pt-4 font-mono text-[11px] tracking-wide text-faint">
